...
// BingoBets is the golang structure for table bingo_bets.
type BingoBets struct {
	...
	SelectedNumbers string      `json:"selectedNumbers" orm:"selected_numbers" description:"玩家选择的10个号码(1-80)，JSON格式: [1,5,12,...]"`       // 玩家选择的10个号码(1-80)，JSON格式: [1,5,12,...]
	DrawnNumbers    string      `json:"drawnNumbers"    orm:"drawn_numbers"    description:"开出的20个号码(1-80)，JSON格式: [3,7,12,...]"`         // 开出的20个号码(1-80)，JSON格式: [3,7,12,...]
