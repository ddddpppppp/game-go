...
// UserBalances is the golang structure for table user_balances.
type UserBalances struct {
	Id            uint64      `json:"id"            orm:"id"             description:"ID"`                                                     // ID
	UserId        uint64      `json:"userId"        orm:"user_id"        description:"用户ID"`                                                   // 用户ID
	Type          string      `json:"type"          orm:"type"           description:"变动类型：deposit-充值, withdraw-提现, game_bet-投注, game_win-收益"` // 变动类型：deposit-充值, withdraw-提现, game_bet-投注, game_win-收益
