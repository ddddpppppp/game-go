...
// KenoDraws is the golang structure of table game_keno_draws for DAO operations like Where/Data.
type KenoDraws struct {
	g.Meta        `orm:"table:game_keno_draws, do:true"`
	Id            interface{} // 主键ID
