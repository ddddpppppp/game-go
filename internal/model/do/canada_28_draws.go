...
// Canada28Draws is the golang structure of table game_canada28_draws for DAO operations like Where/Data.
type Canada28Draws struct {
	g.Meta        `orm:"table:game_canada28_draws, do:true"`
	Id            interface{} // 主键ID
