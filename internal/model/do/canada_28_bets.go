...
// Canada28Bets is the golang structure of table game_canada28_bets for DAO operations like Where/Data.
type Canada28Bets struct {
	g.Meta       `orm:"table:game_canada28_bets, do:true"`
	Id           interface{} // 主键ID
