...
// BingoDynamicOdds is the golang structure of table game_bingo_dynamic_odds for DAO operations like Where/Data.
type BingoDynamicOdds struct {
	g.Meta             `orm:"table:game_bingo_dynamic_odds, do:true"`
	Id                 interface{} //
