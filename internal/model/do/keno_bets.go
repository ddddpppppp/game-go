...
// KenoBets is the golang structure of table game_keno_bets for DAO operations like Where/Data.
type KenoBets struct {
	g.Meta          `orm:"table:game_keno_bets, do:true"`
	Id              interface{} // 主键ID
	MerchantId      interface{} // 商户ID
	UserId          interface{} // 用户ID
	PeriodNumber    interface{} // 期号
	SelectedNumbers interface{} // 玩家选择的10个号码，JSON格式: [1,5,12,...]
	DrawnNumbers    interface{} // 开出的20个号码，JSON格式: [3,7,12,...]
