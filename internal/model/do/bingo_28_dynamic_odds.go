...
// Bingo28DynamicOdds is the golang structure of table game_bingo28_dynamic_odds for DAO operations like Where/Data.
type Bingo28DynamicOdds struct {
	g.Meta             `orm:"table:game_bingo28_dynamic_odds, do:true"`
	Id                 interface{} //
