...
// KenoDynamicOdds is the golang structure of table game_keno_dynamic_odds for DAO operations like Where/Data.
type KenoDynamicOdds struct {
	g.Meta             `orm:"table:game_keno_dynamic_odds, do:true"`
	Id                 interface{} //
