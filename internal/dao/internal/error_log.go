...
// ErrorLogColumns defines and stores column names for the table game_error_log.
...
// errorLogColumns holds the columns for the table game_error_log.
...
func NewErrorLogDao(handlers ...gdb.ModelHandler) *ErrorLogDao {
	return &ErrorLogDao{
		group:    "default",
		table:    "game_error_log",
