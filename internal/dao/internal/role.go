...
// RoleColumns defines and stores column names for the table game_role.
type RoleColumns struct {
	Id         string //
	Name       string //
	Type       string // 1:管理员,2:商户,3:代理,4:个码管理者
...
// roleColumns holds the columns for the table game_role.
